jQuery(document).ready(function(){
    ...
    $('#file-media-uploader').change(function () {
        ...
        jQuery(this).closest('.metabox').find('.image-preview img').attr('src', aksara_url+"/assets/modules/Plugins/PostType/images/preload.gif");
        ...
        if ( jQuery(this).val() != '') {
            aksaraUploader.upload("#file-media-uploader",{
                ...
                failedCallback: function(data){
                    alert('Upload Errror');
                    mediaUploader.closest('.metabox').find('.image-preview img').attr('src', aksara_url+"/assets/modules/Plugins/PostType/images/default-image.png");
                    console.log(data);
                },
