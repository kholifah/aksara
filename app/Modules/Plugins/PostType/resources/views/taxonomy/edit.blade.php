...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">{{ __('plugin:post-type::default.edit-taxonomy', ['taxonomy' => get_current_taxonomy_args('label.name') ]) }}</li>
</ol>
@endsection
...
<div class="content__head">
    <h2 class="page-title">{{ __('plugin:post-type::default.edit-taxonomy', ['taxonomy' => get_current_taxonomy_args('label.name') ]) }}</h2>
</div>
<!-- /.content__head -->
        ...
        <div class="col-lg-6 col-md-8">
            <div class="card-box">
                <div class="card-box__header">
                    <h2>{{ __('plugin:post-type::default.edit-taxonomy', ['taxonomy' => get_current_taxonomy_args('label.name') ]) }}</h2>
                </div>
