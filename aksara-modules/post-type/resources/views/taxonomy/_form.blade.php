<div class="form-group form-group--table {!! $errors->has('name') ? 'error' : '' !!}">
    <label class="col-form-label">{{ __('post-type::default.title') }}</label>
...
<div class="form-group form-group--table {!! $errors->has('slug') ? 'error' : '' !!}">
    <label class="col-form-label">{{ __('post-type::default.slug') }}</label>
    <div class="col-form-input">
...
<div class="form-group form-group--table {!! $errors->has('parent') ? 'error' : '' !!}">
    <label class="col-form-label">{{ __('post-type::default.parent') }}</label>
    <div class="col-form-input">
...
<div class="submit-row clearfix">
    {!! Form::submit( __('post-type::default.save'), ['class'=>'btn btn-md btn-primary alignright']) !!}
</div>
