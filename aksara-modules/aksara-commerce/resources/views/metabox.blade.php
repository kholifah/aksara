<div class="card-box">
    <div class="card-box__header">
        <h2>@lang('aksara-commerce::labels.information_product')</h2>
    </div>
    <div class="card-box__body">
        <div action="" class="form-horizontal">
            <div class="form-group row">
                <label class="col-sm-2 col-xs-4 col-xxs-12 col-form-label">@lang('aksara-commerce::labels.price')</label>
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-xs-4 col-xxs-12 col-form-label">@lang('aksara-commerce::labels.stock')</label>
                <div class="col-sm-10 col-xs-8 col-xxs-12">
