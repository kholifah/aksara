...
<div class="form-group form-group--table {!! $errors->has('date_product') ? 'error' : '' !!}">
    ...
    <div class="col-form-input">
        {!! Form::date('date_product', $product->date_product ?? Carbon\Carbon::now(), ['class'=>'form-control']) !!}
...
<div class="form-group form-group--table {!! $errors->has('date_expired') ? 'error' : '' !!}">
    ...
    <div class="col-form-input">
        {!! Form::date('date_expired', $product->date_expired ?? Carbon\Carbon::now(), ['class'=>'form-control']) !!}
