                ...
                <div class="content">
                    ...
                    <div class="container"> 
                        <div class="content__head">
                            <h2 class="page-title">Pengaturan Kategori <a href="add-category.php" class="page-title-action">Tambah Kategori</a></h2>
                        </div>
                        <!-- /.content__head -->
                                        ...
                                        <table class="datatable-responsive table noborder-top display nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>olahraga</td>
                                                    <td>
                                                        <a href="category.php?edit=1" class="icon-edit"><i title="Edit" class="fa fa-pencil-square-o edit-row" data-toggle="modal" data-target="#edit-komponen"></i> </a>
