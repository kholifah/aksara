                ...
                <div class="content">
                    ...
                    <div class="container"> 
                        <div class="content__head">
                            <h2 class="page-title">Daftar User <a href="add-user.php" class="page-title-action">Tambah User</a></h2>
                        </div>
                        <!-- /.content__head -->
                                        ...
                                        <table class="datatable-responsive table noborder-top display nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Gama</td>
                                                    <td>gama@tonjoo.com</td>
                                                    <td>gamapro</td>
                                                    <td>Admin</td>
                                                    <td>
                                                        <a href="daftar-user.php?edit=1" class="icon-edit"><i title="Edit" class="fa fa-pencil-square-o edit-row" data-toggle="modal" data-target="#edit-komponen"></i> </a>
