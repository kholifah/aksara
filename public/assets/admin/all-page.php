            ...
            <div class="content-page">
                ...
                <div class="content">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Semua Laman</li>
                    </ol>
                    <!-- /.breadcrumb -->

                    <div class="container">
                        <div class="content__head">
                            <h2 class="page-title">Semua Laman <a href="add-page.php" class="page-title-action">Tambah Laman</a></h2>
                        </div>
                        <!-- /.content__head -->
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <ul class="trash-sistem">
                                        <li>
                                            <a href="all-page.php" <?php if(empty($_GET['status'])) echo 'class="current"' ?> >All <span class="count">(<?=$all?>)</span></a> |
                                        </li>
                                        <li>
                                            <a href="all-page.php?status=Published" <?php if(isset($_GET['status']) && $_GET['status'] == 'Published') echo 'class="current"' ?>>Published <span class="count">(<?=$publish?>)</span></a> |
                                        </li>
                                        <li>
                                            <a href="all-page.php?status=Draft" <?php if(isset($_GET['status']) && $_GET['status'] == 'Draft') echo 'class="current"' ?>>Draft <span class="count">(<?=$draft?>)</span></a> |
                                        </li>
                                        <li>
                                            <a href="all-page.php?status=Trash" <?php if(isset($_GET['status']) && $_GET['status'] == 'Trash') echo 'class="current"' ?>>Trash <span class="count">(<?=$trash?>)</span></a>
                                        </li>
                                    </ul>
                                        ...
                                        <table class="datatable-responsive table noborder-top display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="all-page.php?edit=<?=$all_post['id']?>" class="icon-edit"><i title="Edit" class="fa fa-pencil-square-o edit-row" data-toggle="modal" data-target="#edit-komponen"></i> </a>
