...
<html>
    ...
    <title>Daftar Taxonomy dan Term</title>
            ...
            <div class="content-page">
                ...
                <div class="content">                    
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Daftar Taxonomy dan Term</li>
                    </ol>

                    <div class="container">
                        <div class="content__head">
                            <h2 class="page-title">Daftar Taxonomy dan Term <a href="add-term.php" class="page-title-action">Tambah Term</a></h2>
                        </div>
                        <!-- /.content__head -->
